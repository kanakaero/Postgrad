...
subroutine bc_s_k()
    ...
    allocate(T(2, imax, jmax))   ! Temperature array - current and previous iteration values
    ...
    if (bctype_b .eq. 'dir') then
        ...
        do i = 1, imax - 1
            ...
            a_p(i,j) = a_e(i,j) + a_w(i,j) + a_n(i,j) + a_s(i,j) ! Unknown part of source term is added to a_p during the Solver step
